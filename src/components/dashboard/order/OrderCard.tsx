...
export const OrderCard = memo(function OrderCard({ canPrepare = true, canFinish = true, order, expanded, pendingItems, finishing, onToggleExpand, onManage, onTogglePrepared, onFinish }: Props) {
