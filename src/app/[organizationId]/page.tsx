...
export default function ProductMenu() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen overflow-hidden font-sans selection:bg-orange-500 selection:text-white" style={{ backgroundColor: theme.bg, color: theme.text }}>
